...
session_start();
if (isset($_SESSION["addlogin_id"])) { // the std_id session variable is set
?>
<!DOCTYPE html>
<html lang="en">
...
<?php
  ...
  ?>
    ...
    <div id="main">
        ...
        <h1 id="app" class="bg-green-500">Send Feedback</h1>
    </div>
    <section class="text-gray-600 body-font relative">
        <div class="container px-5 py-24 mx-auto">
            ...
            <form  action="../action/feedback_action.php" method="POST">
